...
RUN apt-get update && \
    apt-get install -y build-essential libtiff5-dev libjpeg8-dev libopenjp2-7-dev zlib1g-dev libfreetype6-dev liblcms2-dev libwebp-dev tcl8.6-dev tzdata tk8.6-dev python3-tk libharfbuzz-dev libfribidi-dev libxcb1-dev ffmpeg git curl tree sox zip python3.6 python3-pip python3-llvmlite clang-9 clang-tools-9 clang-tidy-9 clang-format-9 lldb-9 lld-9 && \
