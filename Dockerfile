...
RUN apt-get update && \
    apt-get install -y build-essential zlib1g-dev ffmpeg git curl tree sox zip python3.6 python3-pip python3-llvmlite clang-9 clang-tools-9 clang-tidy-9 clang-format-9 lldb-9 lld-9 && \
